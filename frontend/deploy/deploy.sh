...
cp -r .next/standalone/projects/common_managerment_platform/frontend/* deploy/dist/
cp -r .next/standalone/projects/common_managerment_platform/frontend/.next deploy/dist/
